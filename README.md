...
| ---------       | ------------------ | ------------------------------------        |
| MariaDB Instance  | v26.3.0           | [View README](roles/mariadb_instance/README.md)  |
...
| MongoDb Instance | v0.2.4            | [View README](roles/mongodb_instance/README.md) |
| OpenSearch Cluster  | v3.2.2          | [View README](roles/opensearch_cluster/README.md)  |
