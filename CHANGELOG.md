...
- fix\(helm\): update chart opensearch-operator \(3.0.2 → 3.0.12\) [\#132](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/132) ([plopoyop](https://github.com/plopoyop))
...
- feat\(helm\): update chart mariadb-cluster \(26.6.0 → 26.10.0\) [\#124](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/124) ([plopoyop](https://github.com/plopoyop))

## ⚙️ Dependencies

- feat\(ci\)!: Update ubuntu \(24.04 → 26.04\) [\#123](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/123) ([plopoyop](https://github.com/plopoyop))
...
- fix\(ci\): update renovatebot/github-action action \(v46.2.5 → v46.2.6\) [\#119](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/119) ([plopoyop](https://github.com/plopoyop))
...
- fix\(helm\): update chart redis-cluster \(0.17.5 → 0.17.6\) [\#117](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/117) ([plopoyop](https://github.com/plopoyop))
- feat\(helm\): update chart mongodb-kubernetes \(1.10.0 → 1.11.0\) [\#115](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/115) ([plopoyop](https://github.com/plopoyop))

## ⚙️ Dependencies

- fix\(ci\): update renovatebot/github-action action \(v46.2.4 → v46.2.5\) [\#116](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/116) ([plopoyop](https://github.com/plopoyop))
...
- fix\(helm\): update chart redis-sentinel \(0.16.13 → 0.16.14\) [\#110](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/110) ([plopoyop](https://github.com/plopoyop))
- fix\(helm\): update chart redis-replication \(0.17.0 → 0.17.1\) [\#109](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/109) ([plopoyop](https://github.com/plopoyop))
...
- feat\(helm\): update chart redis-operator \(0.25.0 → 0.26.1\) [\#106](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/106) ([plopoyop](https://github.com/plopoyop))
...
- feat\(helm\): update chart mongodb-instance \(0.4.0 → 0.5.0\) [\#98](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/98) ([plopoyop](https://github.com/plopoyop))

## ⚙️ Dependencies

- fix\(ci\): update renovatebot/github-action action \(v46.2.0 → v46.2.1\) [\#96](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/96) ([plopoyop](https://github.com/plopoyop))

**Merged pull requests:**

- feat\(deps\): update python313packages.ansible \(14.1.0 → 14.2.0\) [\#97](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/97) ([plopoyop](https://github.com/plopoyop))
- fix\(deps\): update prek \(0.4.4 → 0.4.10\) [\#95](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/95) ([plopoyop](https://github.com/plopoyop))
- fix\(deps\): update kubectl \(1.36.2 → 1.36.3\) [\#94](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/94) ([plopoyop](https://github.com/plopoyop))

## [4.0.0](https://github.com/plopoyop/ansible-collection-kubernetes_databases/tree/4.0.0) (2026-08-02)

[Full Changelog](https://github.com/plopoyop/ansible-collection-kubernetes_databases/compare/3.4.0...4.0.0)

## ⛵ Helm Charts

- feat\(helm\): update chart mongodb-kubernetes \(1.9.1 → 1.10.0\) [\#92](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/92) ([plopoyop](https://github.com/plopoyop))
...
- fix\(helm\): update chart postgres-operator-ui \(2.0.0 → 2.0.1\) [\#89](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/89) ([plopoyop](https://github.com/plopoyop))
...
- feat\(ci\): update renovatebot/github-action action \(v46.1.21 → v46.2.0\) [\#93](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/93) ([plopoyop](https://github.com/plopoyop))
- fix\(ci\): update renovatebot/github-action action \(v46.1.20 → v46.1.21\) [\#88](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/88) ([plopoyop](https://github.com/plopoyop))

**Merged pull requests:**

- feat\(deps\): update kind \(0.31.0 → 0.32.0\) [\#85](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/85) ([plopoyop](https://github.com/plopoyop))
- feat\(deps\): update git \(2.54.0 → 2.55.0\) [\#84](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/84) ([plopoyop](https://github.com/plopoyop))
...
- fix\(ci\): update renovatebot/github-action action \(v46.1.19 → v46.1.20\) [\#82](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/82) ([plopoyop](https://github.com/plopoyop))

## [3.3.2](https://github.com/plopoyop/ansible-collection-kubernetes_databases/tree/3.3.2) (2026-07-21)

[Full Changelog](https://github.com/plopoyop/ansible-collection-kubernetes_databases/compare/3.3.1...3.3.2)

## 🐛 Bug Fixes

- Propagate role/phase tags through dynamic include\_tasks [\#81](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/81) ([plopoyop](https://github.com/plopoyop))
...
- fix\(helm\): update chart mongodb-kubernetes \(1.9.0 → 1.9.1\) [\#73](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/73) ([plopoyop](https://github.com/plopoyop))
...
- fix\(ci\): update renovatebot/github-action action \(v46.1.18 → v46.1.19\) [\#76](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/76) ([plopoyop](https://github.com/plopoyop))
...
- feat\(deps\): update python313packages.ansible \(14.0.0 → 14.1.0\) [\#78](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/78) ([plopoyop](https://github.com/plopoyop))
- feat\(deps\): update prek \(0.3.11 → 0.4.4\) [\#77](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/77) ([plopoyop](https://github.com/plopoyop))
...
- feat\(deps\): update python313packages.ansible \(13.6.0 → 13.7.0\) [\#53](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/53) ([plopoyop](https://github.com/plopoyop))
...
- fix\(ci\): update renovatebot/github-action action \(v46.1.13 → v46.1.14\) [\#47](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/47) ([plopoyop](https://github.com/plopoyop))
- fix\(ci\): update renovatebot/github-action action \(v46.1.12 → v46.1.13\) [\#43](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/43) ([plopoyop](https://github.com/plopoyop))
...
- feat\(deps\): update kubernetes-helm \(3.19.1 → 3.20.1\) [\#31](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/31) ([plopoyop](https://github.com/plopoyop))
- fix\(deps\): update prek \(0.3.8 → 0.3.9\) [\#30](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/30) ([plopoyop](https://github.com/plopoyop))
...
[Full Changelog](https://github.com/plopoyop/ansible-collection-kubernetes_databases/compare/2.0.0...3.0.0)
...
- fix\(deps\): update kubectl \(1.35.2 → 1.35.3\) [\#16](https://github.com/plopoyop/ansible-collection-kubernetes_databases/pull/16) ([plopoyop](https://github.com/plopoyop))
